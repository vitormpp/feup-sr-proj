...
a CSV file (produced by pcap_to_csv.py).

Usage
-----
    python outlier.py features.csv
    python outlier.py features.csv --algos iforest lof
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate outlier detectors on features from a CSV file.")
