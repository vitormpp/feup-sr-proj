...
classify.py
===========
Train and evaluate classifiers on features from a CSV file
(produced by pcap_to_csv.py).

Usage
-----
    python classify.py features.csv
    python classify.py features.csv --algos rf lr
    python classify.py features.csv --algos rf svm dt --test-size 0.3
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Classify packets from a features CSV file using ML algorithms.")
